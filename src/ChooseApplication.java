...
public class ChooseApplication extends  JFrame implements PropertyChangeListener {
    ...
    public void AddComponents() {
        //themeSoundChoose = new MySoundEffectChoose("Mercury.wav");
        //themeSoundChoose.playLoop();
        backgroundImg = new MyImageIcon("Resources/jetpack/bg2.jpg").resize(contentpane.getWidth(), contentpane.getHeight());
        drawpane = new JLabel();
        ...
        startBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Thread gameThread = new Thread() {
                    public void run() {
                        //ThatApplication game = new ThatApplication(0, "bg.png", "charL1.png", "charR1.png");
                    }
                };
                gameThread.start();
                setVisible(false);
